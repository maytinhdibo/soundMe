...
export default class Playlist extends Component {
  ...
  render() {
    return (
      ...
      { appConsumer => (
        <View
          style={{ flex: 1, position: "relative", backgroundColor: appConsumer.theme.backgroundColorPlaylist }}
        >
          <Header
            leftComponent={
              <TouchableOpacity
              ...
              >
                <MeIcon size={20} color={appConsumer.theme.colorPrimary} icon={meArrowLeft} />
              </TouchableOpacity>
            }
            rightComponent={
              <View style={{ flexDirection: "row" }}>
                <TouchableOpacity style={{ width: 50, alignItems: "center" }}>
                  <MeIcon size={20} color={appConsumer.theme.colorPrimary} icon={mePlay} />
                </TouchableOpacity>
                <TouchableOpacity
                  style={{ width: 50, alignItems: "center" }}
            ...
            titleComponent={
              <View style={{ paddingLeft: 50 }}>
                <Text
                  style={[{ fontSize: 18, color: appConsumer.theme.colorPrimary }, textStyle.bold]}
                >
                  Danh sách phát
                </Text>
              </View>
